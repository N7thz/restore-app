...
export const DatePickerUpdate = () => {
	...
	const { setValue, watch } = useFormContext<OutputProductExitObjectProps>()
			...
			<Popover open={open} onOpenChange={setOpen}>
				<PopoverTrigger asChild>
					<Button
						...
						{date ? format(date, "P", { locale: ptBR }) : "Selecione a data"}
						<ChevronDownIcon />
					</Button>
				</PopoverTrigger>
				<PopoverContent align="center" className="w-full overflow-hidden p-0">
					<Calendar
						mode="single"
						selected={date}
